...
| --- | --- | --- |
| Default off | A compatible simulated tool is available, but the user asks only for an ordinary handoff. | Complete the base workflow without a Jev call or a key request. Tool availability does not enable review. |
